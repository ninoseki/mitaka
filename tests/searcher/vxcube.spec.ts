...
describe('VxCube', function () {
  ...
  describe('#searchByIP', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByIP(ip)._unsafeUnwrap()).toBe(`http://vxcube.com/tools/ip/${ip}/whois`)
    })
  })
  ...
  describe('#searchByHash', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByHash(hash)._unsafeUnwrap()).toBe(`http://vxcube.com/result/${hash}`)
    })
  })
})
