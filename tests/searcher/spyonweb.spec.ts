...
describe('SpyOnWeb', function () {
  ...
  describe('#searchByIP', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByIP(ip)._unsafeUnwrap()).toBe(`http://spyonweb.net/ip/${ip}`)
    })
  })
  ...
  describe('#searchByDomain', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByDomain(domain)._unsafeUnwrap()).toBe(
        `http://spyonweb.net/domain/${domain}`,
      )
    })
  })
  ...
  describe('#searchByGAPubID', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByGAPubID(id)._unsafeUnwrap()).toBe(`http://spyonweb.net/adsense/${id}`)
    })
  })
  ...
  describe('#searchByGATrackID', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByGATrackID(id)._unsafeUnwrap()).toBe(
        `http://spyonweb.net/analytics/${id}`,
      )
    })
  })
})
