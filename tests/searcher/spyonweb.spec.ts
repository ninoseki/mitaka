...
describe("SpyOnWeb", function () {
  ...
  describe("#searchByIP", function () {
    ...
    it("should return a URL", function () {
      expect(subject.searchByIP(ip)).toBe(`http://spyonweb.com/${ip}`);
    });
  });
  ...
  describe("#searchByGAPubID", function () {
    ...
    it("should return a URL", function () {
      expect(subject.searchByGAPubID(id)).toBe(`http://spyonweb.com/${id}`);
    });
  });
  ...
  describe("#searchByGATrackID", function () {
    ...
    it("should return a URL", function () {
      expect(subject.searchByGATrackID(id)).toBe(`http://spyonweb.com/${id}`);
    });
  });
});
