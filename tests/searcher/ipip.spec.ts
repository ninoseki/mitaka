...
describe('IPIP', function () {
  ...
  describe('#searchByIP', function () {
    ...
    it('should return a URL', function () {
      expect(subject.searchByIP(ip)._unsafeUnwrap()).toBe(`https://en.ipip.net/ip/${ip}.html`)
    })
  })
  ...
  describe('#searchByASN', function () {
    const asn = 'AS13335'
    it('should return a URL', function () {
      expect(subject.searchByASN(asn)._unsafeUnwrap()).toBe(`https://whois.ipip.net/${asn}`)
    })
  })
})
