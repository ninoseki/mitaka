...
describe("FortiGuard", () => {
  ...
  describe("#searchByURL", () => {
    it("should return URL", () => {
      expect(subject.searchByURL("https://github.com")).to.equal("https://fortiguard.com/webfilter?q=https%3A%2F%2Fgithub.com");
    });
  });
  describe("#searchByCVE", () => {
    it("should return URL", () => {
      expect(subject.searchByCVE("CVE-2017-2991")).to.equal("https://fortiguard.com/search?q=CVE-2017-2991&engine=3");
    });
  });
});
